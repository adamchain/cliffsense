...
export const ALERT_PLAYBOOKS: Record<string, AlertPlaybook> = {
  ...
  dac_sga_disability: pb(
    ...
    "Report work to SSA promptly. Keep medical evidence current. Do not assume marriage or wages are ignored.",
  ),
  ...
  ssdi_waiver_twilight: pb(
    ...
    ["SSDI", "MedicaidWaiver"],
    "Earnings at SGA can suspend SSDI cash after nine recorded Trial Work Period months, or can end a DAC disability finding with no trial work period, while income is still under the $2,982 waiver limit.",

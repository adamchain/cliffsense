...
export const ELIGIBILITY_LOSS_SCENARIOS: EligibilityLossScenario[] = [
  ...
  },
  {
    ...
    trigger: "reporting",
    level: "breach",
    risk: "A lump sum is income in the month it arrives. Money still held the next month is a resource, and it can put the total over $2,000 ($3,000 for an SSI couple).",
